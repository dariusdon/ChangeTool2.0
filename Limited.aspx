<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Limited.aspx.cs" Inherits="ChangeTool2._0.Limited" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Limited/Limitate</title>
</head>
<body style="padding-left: 100px;
    ...
    <form id="form1" runat="server">
        <div>
            <p style="font-size:30px; margin-left: 690px; margin-top:0px; color: #ffa500"><u>
            <asp:Label ID="Label1" runat="server" Text="Limitate/Limited"></asp:Label>
            </u></p>
        </div>
        <br />
        ...
        <div style="margin-left:150px; margin-top: 50px;font-size:26px">
        ...
        <div style="margin-top:0px; margin-left:-50px">
            <asp:GridView ID="GridView1" OnSelectedIndexChanged="OnSelectedIndexChanged" DataKeyNames="ID,Created_by,StartDate,Status_" Width="1500px" OnRowDeleting="RowDeleting" AllowPaging="true" Font-size="20px"  runat="server" HeaderStyle-BackColor="#ffa500" HeaderStyle-ForeColor="Black" PageSize="10"  onpageindexchanging="GrdEmp_PageIndexChanging" AllowSorting="true" OnSorting="Details_sort">
         ...
         <PagerStyle backcolor="#ffa500"
          ...
          horizontalalign="Right"/>
                  <Columns>
                      ...
                      <asp:CommandField ButtonType="Image" DeleteImageUrl= "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThjl7mlwlpu7GjhxWZhtQIHCVajZN9Hh1FMGXeBRu5_OQBsnTgmE5t74V03FPuN5SQQ7E&usqp=CAU" ControlStyle-Width="30" Visible="false" ShowDeleteButton="false" HeaderText ="Delete"/>
                  </Columns>
     </asp:GridView>
        </div>
        <div style="margin-left: 550px;margin-top: 10px; width: 90%; height:125px;background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvui-KTGNqCJAMjNpGsdev9taMQu9MD98IwQ&usqp=CAU);background-repeat:no-repeat;">
