<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCreate.aspx.cs" Inherits="ChangeTool2._0.MyCreate" %>

<link rel="stylesheet" href="CSS/MyCreateCSS" />

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MyCreatePage</title>
</head>
<body style="padding-left: 100px;
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="My Create Page"></asp:Label>
            </u></p>
        </div>
        <br />
