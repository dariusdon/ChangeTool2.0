<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ApprovalList.aspx.cs" Inherits="ChangeTool2._0.ApprovalList" %>
<link rel="stylesheet" href="CSS/1.css" />
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lista Aprobare/Approval List</title>
</head>
<body style="padding-left: 100px;
    ...
    <form id="form1" runat="server">
        <div>
            <p style="font-size:30px; margin-left: 600px; color: #ffa500"><u>
            <asp:Label ID="Label1" runat="server" Text="Lista Aprobare/Approval List"></asp:Label>
            </u></p>
        </div>
        <br />
        ...
        <div style="margin-left:150px; margin-top: 50px;font-size:26px">
            ...
            <asp:Label runat="server" Text="Cauta Dupa/Search By:"></asp:Label>
                ...
                <asp:Button ID="Button4" style="width:150px;height: 35px;font-size:20px" runat="server" Text="Sterge Filtru" OnClick="Button4_Click" />
                </div>
        <p />
