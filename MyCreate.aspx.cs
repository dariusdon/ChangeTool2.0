...
{
    public partial class MyCreate : System.Web.UI.Page
    {
        ...
        public void status_created()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    FROM [dbo].[Change2_0]
                    WHERE Created_By = '" + Session["name"] + "' AND Status_ = 'Created';";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                    {
        ...
        public void status_pend()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string sql = @"SELECT Count(*) AS Status_Created
                    FROM [dbo].[Change2_0]
                     WHERE Created_By = '" + Session["name"] + "' AND Status_ = 'Pending';";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                    {
        ...
        public void status_reject()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string sql = @"SELECT Count(*) AS Status_Created
                    FROM [dbo].[Change2_0]
                    WHERE Created_By = '" + Session["name"] + "' AND Status_= 'Rejected';";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                    {
        ...
        public void status_releasing()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string sql = @"SELECT Count(*) AS Status_Created
                    FROM [dbo].[Change2_0]
                    WHERE Created_By = '" + Session["name"] + "' AND Status_ = 'Release';";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                    {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    string sql = @"SELECT [ID]
                                  ...
                                  ,[Status_]
                                  FROM [dbo].[Change2_0]
                                Where ([Created_By] = '" + Session["name"] + "') AND ([Created_By] LIKE '%" + str + @"%' 
                    ...
                    using (SqlConnection con = new SqlConnection(constr))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand())
                        {
                            string sql = @"select [ID]
                                          ...
                                          ,[informer5]
                                          ,[informer6]
                            FROM [dbo].[Change2_0] where id = '" + id + "' ORDER By [ID] ASC; ";
