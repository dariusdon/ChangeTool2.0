<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovalView.aspx.cs" Inherits="ChangeTool2._0.ApprovalView" %>
    ...
    <form id="form1" runat="server">
        <div>
           <p style="font-size:30px; margin-left:50px">
            ...
            <asp:Button ID="Button1" runat="server" Font-Bold="true" Font-Size="20px" Text="Accept" OnClick="Button1_Click"/>

            <asp:Button ID="Button2" runat="server" Font-Bold="true" Font-Size="20px" Text="Reject" OnClick="Button2_Click"/>
            ...
            <textarea id="textarea2"  style="width:300px; height:100px;" runat="server"></textarea>
            </p>
            <p style="margin-left:300px;font-size:20px; margin-top:-640px" id="para" runat="server">
                <asp:Button ID="Button3" Font-Size="20px" runat="server" Text="Vezi Fisier!/See file!" OnClick="Download"/>
            </p>
            <style type="text/css">
