...
namespace ChangeTool2._0
{
    public partial class ApprovalList : System.Web.UI.Page
    {
        ...
        // astea pentru view din fericire
        public static string number;
        
        public static string create;
        public static string start;
        public static string end;
        public static string poms;
        public static string department;
        public static string masina;
        public static string code;
        public static string cantitate;
        public static string conditii;
        public static string others;
        public static string cerere;
        public static string action;
        public static string instructiuni;
        public static string status;
       
        public static string index;
        public static string approval1;
        public static string approval2;
        public static string approval3;
        public static string approval4;
        public static string approval5;
        public static string approval6;
        ...
        public static string informer1;
        public static string informer2;
        public static string informer3;
        public static string informer4;
        public static string informer5;
        public static string informer6;
        
        // sa nu uiti de fisier ca trebuie sa fie salvat
        //dar unde sa salvez fisierul
        //eventual in sharepoint
        //dar acolo nu are access toata lumea
        //aici se termina astea de view
        ...
        public void status_created()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    FROM [dbo].[Change2_0]
                    WHERE Status_ = 'Created' and (approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '"
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "');";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                    {
        ...
        public void status_pend()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string sql = @"SELECT Count(*) AS Status_Created
                    FROM [dbo].[Change2_0]
                    WHERE Status_ = 'Pending' and (approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '"
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "');"; ;
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
        ...
        public void status_reject()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string sql = @"SELECT Count(*) AS Status_Created
                    FROM [dbo].[Change2_0]
                    WHERE Status_ = 'Rejected' and (approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '"
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "');";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
        ...
        public void status_releasing()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string sql = @"SELECT Count(*) AS Status_Created
                    FROM [dbo].[Change2_0]
                    WHERE Status_ = 'Release' and (approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '"
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "');";
                    cmd.CommandText = sql;
                    cmd.Connection = con;
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    string sql = @"SELECT [ID]
                               ...
                               FROM [dbo].[Change2_0]
                               WHERE approval1 = '"+Session["name"]+"' or approval2 = '" + Session["name"] + "' or approval3 = '" +Session["name"]+ "' " +
                               "or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "'  or approval6 = '" + Session["name"] + "' ORDER BY [ID] DESC ";
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    string sql = @"SELECT [ID]
                              ...
                              FROM [dbo].[Change2_0]
                              WHERE approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '"
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "' ORDER By [ID] ASC";
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    string sql = @"SELECT [ID]
                                  ...
                                  FROM [dbo].[Change2_0]
                                Where (approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '"
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "' ) AND ([ID] LIKE '%" + str + @"%' 
                                OR [Created_By] LIKE '%" + str + @"%' 
                    ...
                    using (SqlConnection con = new SqlConnection(constr))
                    {
                        using (SqlCommand cmd = new SqlCommand())
                        {
                            string sql = @"select [ID]
                                          ...
                                          ,[informer5]
                                          ,[informer6]
                            FROM [dbo].[Change2_0] where id = '" + id + "' and (approval1 = '" + Session["name"] + "' or approval2 = '" + Session["name"] + "' or approval3 = '" 
                            + Session["name"] + "' or approval4 = '" + Session["name"] + "' or approval5 = '" + Session["name"] + "' or approval6 = '" + Session["name"] + "') ";
                            ...
                            using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                            {
                                ...
                                Session["deparmentA"] = Convert.ToString(dt.Rows[0]["department"]);
                                ...
                                others = Convert.ToString(dt.Rows[0]["Other_Condition"]);
